...
def part_2_problem_1():
	...
	X_train_norm = np.roll(np.append(normalize(X_train_set, axis=0), Y_actual_train, 1), 1)
	X_test_norm = np.roll(np.append(normalize(X_test_set, axis=0), Y_actual_test, 1), 1)
